      ...
      >
        ...
        <section className="py-16 md:py-20 lg:py-24 bg-[#0a0a0a] flex flex-col items-center justify-center text-center px-4 md:px-6 relative overflow-hidden">
          ...
          >
            ...
            >
              {getSetting("ABOUT_TITLE", "READY TO POWER UP?")}
            </motion.h2>
            <motion.p
            ...
            >
              {getSetting("BRAND_MANIFESTO", "Experience maximum energy boost with premium energy drinks. Engineered for peak performance and explosive flavors.")}
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
