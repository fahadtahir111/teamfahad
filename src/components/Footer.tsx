...
import { Zap, Github, Twitter, Instagram, MessageCircle } from "lucide-react";
    ...
    return (
        <footer className="bg-background border-t border-white/5 py-20 px-6">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
                <div className="flex flex-col gap-6">
                    <div className="flex items-center gap-2">
                        <div className="w-10 h-10 bg-energy rounded-xl flex items-center justify-center text-white font-black italic text-xl">
                    ...
                    <div className="flex gap-4">
                        {getSetting("SOCIAL_X") && (
                            <a href={getSetting("SOCIAL_X")} target="_blank" rel="noopener noreferrer">
                        ...
                        {getSetting("SOCIAL_DISCORD") && (
                            <a href={getSetting("SOCIAL_DISCORD")} target="_blank" rel="noopener noreferrer">
                                <MessageCircle className="w-5 h-5 text-white/40 hover:text-energy cursor-pointer transition-colors" />
                            </a>
                        )}
                    </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex flex-col gap-2">
                    <p className="text-[10px] font-black uppercase tracking-widest text-white/20 italic">© 2026 {getSetting("BRAND_NAME") || "BUBBLOE"}. ALL RIGHTS RESERVED.</p>
